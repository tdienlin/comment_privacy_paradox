...
We rebuild the model reported in the paper.
...
"
fit_reported <- lavaan::sem(model, sample.cov = cor_ma, sample.nobs = n_hm)
```
...
"
fit_saturated <- lavaan::sem(model, sample.cov = cor_ma, sample.nobs = n_hm)
```
